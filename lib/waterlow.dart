  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        header('Физическое телосложение / масса тела'),
        RadioListTile(
            title: Text('Среднее'),
            value: _val3,
            groupValue: 0,
        ...
        RadioListTile(
            title: Text('Используется катетер, но имеется недержание кала'),
            value: _val4,
            groupValue: 2,
            onChanged: (val) {
              setState(() {
        ...
        header('Отклонение состояния кожи'),
        CheckboxListTile(
        ...
        header('Способность к передвижению'),
        RadioListTile(
            title: Text('Полная'),
            value: _val5,
            groupValue: 0,
