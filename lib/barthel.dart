...
class Barthel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        header('Контроль мочеиспускания'),
        RadioListTile(
            title: Text(
        ...
        RadioListTile(
            title: Text('Случайные инциденты (максимум 1 раз за 24 часа)'),
            value: _val2,
            groupValue: 5,
            onChanged: (val) {
              setState(() {
        ...
        header('Перемещение (с кровати на стул и обратно)'),
        RadioListTile(
            title: Text(
        ...
        header('Одевание'),
        RadioListTile(
            title: Text('Полностью зависим от помощи окружающим'),
            value: _val8,
            groupValue: 0,
            onChanged: (val) {
              setState(() {
        ...
        result(barthelResult, _total, _val1, _val2, _val3, _val4, _val5, _val6,
            _val7, _val8, _val9, _val10),
        SizedBox(
          height: 20,
        ),
      ],
